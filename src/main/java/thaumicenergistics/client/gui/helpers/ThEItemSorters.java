...
public class ThEItemSorters {
    ...
    public static final Comparator<IAEStack<?>> CONFIG_BASED_SORT_BY_NAME =
            (o1, o2) -> {
                final int cmp =
                        AEUtil.getDisplayName(o1).compareToIgnoreCase(AEUtil.getDisplayName(o2));
                return applyDirection(cmp);
            };

    public static final Comparator<IAEStack<?>> CONFIG_BASED_SORT_BY_MOD =
            (o1, o2) -> {
                int cmp = getModID(o1).compareToIgnoreCase(getModID(o2));

                if (cmp == 0) {
                    cmp =
                            Platform.getItemDisplayName(o1)
                                    .compareToIgnoreCase(Platform.getItemDisplayName(o2));
                }

                return applyDirection(cmp);
            };

    public static final Comparator<IAEStack<?>> CONFIG_BASED_SORT_BY_SIZE =
            (o1, o2) -> {
    ...
    public static final Comparator<IAEStack<?>> CONFIG_BASED_SORT_BY_INV_TWEAKS =
            (o1, o2) -> {
                ...
                final int cmp =
                        api.compareItems(
                                o1.asItemStackRepresentation(), o2.asItemStackRepresentation());
                return applyDirection(cmp);
            };
