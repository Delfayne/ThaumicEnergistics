...
public class PacketHandler {
    ...
    public static void register() {
        ...
        PacketHandler.INSTANCE.registerMessage(
                ...
                Side.CLIENT);
        PacketHandler.INSTANCE.registerMessage(
                PacketSettingChange.HandlerClient.class,
                PacketSettingChange.class,
                PacketHandler.nextID(),
                Side.CLIENT);
        PacketHandler.INSTANCE.registerMessage(
                PacketIsArcaneUpdate.Handler.class,
                PacketIsArcaneUpdate.class,
                PacketHandler.nextID(),
                Side.CLIENT);
        PacketHandler.INSTANCE.registerMessage(
                PacketPlaySound.Handler.class,
                PacketPlaySound.class,
                PacketHandler.nextID(),
                Side.CLIENT);
        PacketHandler.INSTANCE.registerMessage(
                PacketAssemblerGUIUpdate.Handler.class,
        ...
        PacketHandler.INSTANCE.registerMessage(
                ...
                PacketUIAction.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                PacketSettingChange.HandlerServer.class,
                PacketSettingChange.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                PacketJEIRecipe.Handler.class,
                PacketJEIRecipe.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                ...
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                PacketCraftRequest.Handler.class,
                PacketCraftRequest.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                PacketSubscribe.Handler.class,
                PacketSubscribe.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                PacketEssentiaFilterAction.Handler.class,
                PacketEssentiaFilterAction.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
                PacketAssemblerGUIUpdateRequest.Handler.class,
                PacketAssemblerGUIUpdateRequest.class,
                PacketHandler.nextID(),
                Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
    ...
    public static void sendToPlayer(EntityPlayerMP player, IMessage message) {
        if (!(message instanceof PacketVisUpdate)) {
            ...
            //            message.toBytes(buf);
            //            ThELog.info("sendToPlayer readableBytes {} | read {} | write {} | message
    ...
    public static void sendToServer(IMessage message) {
        if (!(message instanceof PacketVisUpdate)) {
            ...
            message.toBytes(buf);
            ThELog.trace(
                    "sendToServer readableBytes {} | read {} | write {} | message {}",
                    buf.readableBytes(),
                    buf.readerIndex(),
                    buf.writerIndex(),
                    message.getClass().getSimpleName());
    ...
    public static void sendToAll(IMessage message) {
        if (!(message instanceof PacketVisUpdate)) {
            ...
            message.toBytes(buf);
            ThELog.trace(
                    "sendToAll readableBytes {} | read {} | write {} | message {}",
                    buf.readableBytes(),
                    buf.readerIndex(),
                    buf.writerIndex(),
                    message.getClass().getSimpleName());
